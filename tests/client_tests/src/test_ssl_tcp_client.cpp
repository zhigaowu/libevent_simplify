...
#include "ssl/client_certificate.h"
...
int test_ssl_tcp_client(io_simplify::libevent::BaseConfig& base_config, int argc, char **argv) 
{
    io_simplify::ssl::Initialize();

    io_simplify::ssl::ClientCertifcate certificate;
